...
#----皮爾森分析熱力圖--------
originaldataset = pd.read_csv('./1A-test(2013-2016).csv', header=0, index_col=0)
plt.figure(figsize=(9,7))
sns.heatmap(originaldataset.corr(),annot = True,cmap ='YlOrRd',square =True)
plt.title('1A_solar_energy_pollution',fontsize = 18,pad ='20')
plt.show()
#plt.savefig("1A_solar_energy_Pearson.jpg")
...
data = pd.read_csv('./1A_solar_energy_Pearson.csv', header=0, index_col=0)
